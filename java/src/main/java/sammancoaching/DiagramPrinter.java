...
public class DiagramPrinter {
    ...
    public boolean printSummary(FlowchartDiagram diagram, String language, StringBuilder summaryText) {
        ...
        return buildSummary(diagramWrapper, language, summaryText);
    }

    public boolean buildSummary(DiagramWrapperInterface diagramWrapper, String language, StringBuilder summaryText) {
    ...
    public boolean printDiagram(FlowchartDiagram diagram, String folder, String filename) throws IOException {
        ...
        if (PDF.equals(info.fileType)) {
            return printPdf(new DiagramWrapper(diagram), folder, filename, info);
        }
    ...
    public boolean printPdf(DiagramWrapperInterface diagram, String folder, String filename, DiagramMetadata info) {
        String targetFilename = getTargetFilename(folder, filename);
        return diagram.copyPdf(diagram, info, targetFilename);
    }
